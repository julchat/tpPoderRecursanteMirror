...
comanda_config* leer_config_comanda(char* path){
	...
	config_comanda_aux->TAMANIO_MEMORIA = config_get_int_value(config_aux,"TAMANO_MEMORIA");
	config_comanda_aux->TAMANO_SWAP = config_get_int_value(config_aux,"TAMANO_SWAP");
	config_comanda_aux->FRECUENCIA_COMPACTACION = config_get_int_value(config_aux,"FRECUENCIA_COMPACTACION");
